  ...
  void _readClipboard() async {
    ...
    setState(() {
      ...
      if (clipboardData != null) {
        // Use clipboardData.text to access the clipboard contents
        _clips.add(clipboardData.text!);
        print('Clipboard contents: ${clipboardData.text}');
      }
    });
  }
